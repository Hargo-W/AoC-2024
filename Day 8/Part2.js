...
const addAntinode = (coords, delta) => {
    if (coords[0] > yMax - 1 || coords[0] < 0) return
    if (coords[1] > xMax - 1 || coords[1] < 0) return
    antinodes.add(coords.toString())
    addAntinode([coords[0] + delta[0], coords[1] + delta[1]], delta)
}

const addAllAntinodes = (coords1, coords2) => {
    const delta1 = [coords1[0] - coords2[0], coords1[1] - coords2[1]]
    const delta2 = [coords2[0] - coords1[0], coords2[1] - coords1[1]]

    addAntinode(coords1, delta1)
    addAntinode(coords2, delta2)
}
...
for (let antenna in antennas) {
    ...
    for (let i = 0; i < locations.length; i++) {
        ...
        for (let y = 0; y < locations.length; y++) {
            ...
            addAllAntinodes(currentLocation, otherLocation)
        }
    }
}
